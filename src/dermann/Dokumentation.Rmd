...
```{r,warning=FALSE}
visualizer <- function (raster, vector, palname="Reds"){
...
Now the classes for the visualization of the vector are being chosen. In this case we are using the number of natural species, saved under NAT. As the values range between 0 and 9 the classes range from 0 to 10.
...
plot(Beob.Punkte)
plot(Beob)
visualizer(landsat_Kanal3, Beob.Punkte, "Greens")
```
